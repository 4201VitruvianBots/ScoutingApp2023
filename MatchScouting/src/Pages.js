        ...
        <Page selected={props.selected} id="auto">
            ...
            <div className="textArea">
                ...
                <div className="gallery">
                    ...
                    <div className="cones">
                        <h1 className="conecube"><img src="Cone Icon.svg" height="50" className="Icon" alt="Cone Icon"/>Cones</h1>
                        <NumberInput id="Auto_Cone_High" />
                        <NumberInput id="Auto_Cone_Mid" />
                        <NumberInput id="Auto_Cone_Low" />
                    </div>
                    <div className="cubes">
                        <h1 className="conecube"><img src="Cube Icon.svg" height="50" className="Icon" alt="Cube Icon"/>Cubes</h1>
